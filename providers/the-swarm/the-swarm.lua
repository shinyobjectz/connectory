...
return {
  ...
  operations = {
    ...
    ["the-swarm.get_post_comments"] = { method = "GET", url = "https://bee.theswarm.com/social/post/{urn}/comments", path = {"urn"}, query = {"perPage", "paginationToken"} },
    ["the-swarm.get_post_reactions"] = { method = "GET", url = "https://bee.theswarm.com/social/post/{urn}/reactions", path = {"urn"}, query = {"perPage", "paginationToken"} },
    ["the-swarm.get_post_reshares"] = { method = "GET", url = "https://bee.theswarm.com/social/post/{urn}/reshares", path = {"urn"}, query = {"perPage", "paginationToken"} },
    ...
    ["the-swarm.get_refreshed_profile"] = { method = "GET", url = "https://bee.theswarm.com/v3/profiles/fetch/refresh", query = {"linkedinName"} },
